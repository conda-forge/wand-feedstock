...
Once the `conda-forge` channel has been enabled, `wand` can be installed with:

```
conda install wand
```

It is possible to list all of the versions of `wand` available on your platform with:
